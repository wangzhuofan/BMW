...
bayes_multi_n <- function(y,c1,c2,c3){
  set.seed(1)
  {
    ...
    c2track <- list()
    c3track <- list()
    al=1;bl=3;av=1;bv=10;am=5;bm=1;sigmal=1;mub=-1
    ;sigmab=5;arho=1;brho=1;psi_1=0.5;psi0=6;psi1=0.5;as=1;bs=1;sigmamu=10;
...
save.image("sen(psi_1=0.5,psi0=6,psi1=0.5).RData")